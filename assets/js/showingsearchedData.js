...
function returnFlightData() {
    ...
    for (i = 0; i < 11; i++) {
        if (i === 0 || i % 2 == 0) {
            ...
            departure.innerHTML = departurecityname.data[0].address.cityName + " (" + finalreturndata.data[i].itineraries[0].segments[0].departure.iataCode + ")";
            arrival.innerHTML = arrivalcityname.data[0].address.cityName + " (" + finalreturndata.data[i].itineraries[0].segments[0].arrival.iataCode + ")";
            DEtime.innerHTML = finalreturndata.data[i].itineraries[0].segments[0].departure.at;
            ARtime.innerHTML = finalreturndata.data[i].itineraries[0].segments[0].arrival.at;
            flightclass.innerHTML = finalreturndata.data[i].travelerPricings[0].fareDetailsBySegment[0].cabin;
            price.innerHTML = finalreturndata.data[i].travelerPricings[0].price.total + "EUR";
